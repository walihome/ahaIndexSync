...
""",
    "tweet": """
这是一位 AI 领域关键人物近期发布的原创推文合集，请：
  1. 过滤掉日常闲聊、无意义内容，只关注观点、判断、预测、资讯
  2. 提炼出 2-3 个最值得关注的核心观点（每个观点一句话）
  3. summary 格式：「@用户名 近期观点：① xxx ② xxx」，不超过120字
  4. processed_title 格式：「@用户名：[最核心的一个观点]」，15字以内
""",
    "default": """
summary（2句话，不超过100字）：
  第1句：这是什么/做了什么（事实）
